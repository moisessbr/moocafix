...
<!-- Basic Page Needs
	================================================== -->
	<meta charset="utf-8">
	<title>Mooca Fix - Sistema de Ordens de Serviço</title>
									...
									<div class="container">
										...
										<div class="row">
											<div class="span12 text-center mb40">
												...
												<h2 class="subTitle">Escolha e clique na opção abaixo.</h2>
											</div>
...
<br>
						...
						<div class="col-sm-6">
						<a href="preencher-ordem.php"><button type="button" class="btn btn-default btn-svsx btn-block">Consertar</button></a></div>          
                        <div class="col-sm-6">
						<a href="consultar-ordem.php"><button type="button" class="btn btn-default btn-svsx btn-block">Consultar OS</button></a></div>
